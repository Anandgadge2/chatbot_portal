...
const translations = {
  en: {
    welcome: '🇮🇳 *Collectorate Jharsuguda Odisha - Official Digital Portal*\n\nNamaskar! Welcome to the official WhatsApp service of Collectorate Jharsuguda Odisha.\n\nWe are dedicated to providing transparent and efficient services to all citizens.\n\n👇 *Please select your preferred language:*',
  ...
  hi: {
    ...
    goodbye: '👋 *धन्यवाद*\n\nकलेक्टोरेट झारसुगुड़ा ओडिशा से संपर्क करने के लिए धन्यवाद। हम आपकी सेवा में हमेशा तत्पर हैं।\n\n📞 *सहायता के लिए:*\n• कभी भी "Hi" टाइप करें\n• "Help" टाइप करें हेल्पडेस्क जानकारी के लिए\n• "Menu" टाइप करें सभी सेवाएं देखने के लिए\n\n🌐 *वेबसाइट:* jharsuguda.gov.in\n📍 *कार्यालय:* कलेक्टोरेट झारसुगुड़ा ओडिशा\n\n_कार्यालय समय: सुबह 10:00 - शाम 6:00 (सोम-शनि)_',
  ...
  mr: {
    ...
    mainMenu: '🏛️ *नागरिक सेवा मेनू*\n\nकलेक्टोरेट झारसुगुडा ओडिशा डिजिटल हेल्पडेस्कमध्ये आपले स्वागत आहे.\n\n👇 *कृपया खालील पर्यायांमधून सेवा निवडा:*',
    ...
    goodbye: '👋 *धन्यवाद*\n\nकलेक्टोरेट झारसुगुडा ओडिशाशी संपर्क साधल्याबद्दल धन्यवाद. आम्ही नेहमी तुमच्या सेवेसाठी तत्पर आहोत.\n\n📞 *मदतीसाठी:*\n• कधीही "Hi" टाइप करा\n• "Help" टाइप करा हेल्पडेस्क माहितीसाठी\n• "Menu" टाइप करा सर्व सेवा पाहण्यासाठी\n\n🌐 *वेबसाइट:* jharsuguda.gov.in\n📍 *कार्यालय:* कलेक्टोरेट झारसुगुडा ओडिशा\n\n_कार्यालय वेळ: सकाळी 10:00 - संध्याकाळी 6:00 (सोम-शनि)_',
  ...
  or: {
    welcome: '🇮🇳 *କଲେକ୍ଟୋରେଟ୍ ଝାରସୁଗୁଡା ଓଡ଼ିଶା - ଅଧିକାରିକ ଡିଜିଟାଲ ପୋର୍ଟାଲ*\n\nନମସ୍କାର! କଲେକ୍ଟୋରେଟ୍ ଝାରସୁଗୁଡା ଓଡ଼ିଶା ର ଅଧିକାରିକ ୱହାଟସଆପ ସେବାରେ ସ୍ୱାଗତ।\n\nଆମେ ସମସ୍ତ ନାଗରିକଙ୍କୁ ସ୍ୱଚ୍ଛ ଏବଂ କାର୍ଯ୍ୟକ୍ଷମ ସେବା ପ୍ରଦାନ କରିବାକୁ ପ୍ରତିବଦ୍ଧ।\n\n👇 *ଦୟାକରି ଆପଣଙ୍କର ପସନ୍ଦିତ ଭାଷା ବାଛନ୍ତୁ:*',
...
export async function processWhatsAppMessage(message: ChatbotMessage): Promise<any> {
  ...
  // Ensure enabledModules is set - if not, default to GRIEVANCE and APPOINTMENT for Collectorate Jharsuguda Odisha
...
async function startAppointmentFlow(session: UserSession, message: ChatbotMessage, company: any) {
  // Appointment is only for CEO/Head of Collectorate Jharsuguda Odisha - no department selection
  ...
  switch (session.step) {
    ...
    case 'appointment_time':
      ...
      const confirmMessage = `${getTranslation('appointmentConfirm', session.language)}\n\n` +
        ...
        `*${getTranslation('label_department', session.language)}:* Collectorate Jharsuguda Office\n` +
...
async function handleStatusTracking(
  ...
  // Professional formatting for Appointment (else if because we searched both but might want to prioritize specific ID match)
    ...
    const deptName = 'Collectorate Jharsuguda Office';
